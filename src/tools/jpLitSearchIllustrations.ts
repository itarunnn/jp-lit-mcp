...
export function createJpLitSearchIllustrationsTool(nextDlClient: NextDigitalLibraryClient) {
  return async (input: unknown) => {
    ...
    const structuredContent: SearchIllustrationsOutput = searchIllustrationsOutputSchema.parse({
