...
- 地方人物・地方紙・地方雑誌・郷土資料: 地域候補を優先づけ、Web 検索で実在館名を拾ってからカーリル MCP / 地域公共図書館 OPAC
...
実検索では、原則として `source` 未指定の `jp_lit_search(query=...)` から始めない。`ndl_search` と `japan_search` を基礎候補にし、レファ協・リサーチ・ナビで示唆された source 候補と組み合わせ、初手は 2〜4 source に絞る。レファ協・NDL リサーチ・ナビ、またはドメイン判定で有効な DB / source が示唆された場合は、その source も初手に加える。
...
地方人物・地方紙・地方雑誌・郷土資料が主題の場合は、`ndl_search` / `japan_search` / レファ協 / リサーチ・ナビで地域候補を作り、Web 検索で実在する地域図書館名、地域パスファインダー、新聞・雑誌所蔵一覧、郷土資料ページを拾ってからカーリル MCP へ進む。人名はまず出身地・居住地・活動地・郷土人物としての地域を割り、地域から図書館へ進める。文学館、記念館、資料館、専門図書館、資料室への直接導線は補助として探す。媒体名・団体名からは所蔵館や資料室の導線も探す。県立図書館を基準点として外さない。優先する館は、該当都道府県立図書館、該当市区町村中央館、県内/広域の図書館ネットワーク、発行地・活動地に対応する中央館、郷土資料室・分館、隣接自治体や旧郡域の館、専門図書館・資料室。地方紙・地方雑誌は記事名ではなく媒体名・巻号で OPAC 所蔵を確認する。
