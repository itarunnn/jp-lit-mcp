...
describe("session store history", () => {
  ...
  it("ignores legacy archived sessions in listAll", async () => {
    ...
    const legacyOnly: SessionDocument = {
      session_id: "2026-04-28-090000",
      created_at: "2026-04-28T09:00:00.000Z",
      updated_at: "2026-04-28T09:10:00.000Z",
      entries: []
    };
    const duplicateLegacy: SessionDocument = {
      session_id: "2026-05-01-140000",
      created_at: "2026-05-01T14:00:00.000Z",
      updated_at: "2026-05-01T14:05:00.000Z",
      entries: []
    };
    const duplicateNew: SessionDocument = {
      session_id: "2026-05-01-140000",
      created_at: "2026-05-01T14:00:00.000Z",
