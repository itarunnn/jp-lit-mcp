...
自費出版、個人出版支援、オンデマンド出版、一般向け新書は通常、二次文献・解説的媒体として慎重に扱います。主題に一致するだけで `優先: 高` にはせず、著者属性、典拠の扱い、引用状況、専門的な書評・批判・応答、本文確認状況を見て、`中` または `保留` から評価します。著者が当事者である、刊行時期が論争や出来事と近い、本文が同時代証言や受容史を示す、といった条件が確認できる場合は、調査上の価値を個別に評価します。
