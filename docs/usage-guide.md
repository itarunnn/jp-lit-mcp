...
```text
雑誌『LA VIE』（ルーツ出版、1979年創刊）の所蔵機関を確認してください。
```
...
```text
1925年の官報で、普通選挙法の公布に関する記録を探して、ページも特定してください。
```
...
```text
明治・大正期の「職業婦人」に関する文献を、当時の表記や関連語も含めて探してください。
```
...
```text
国会会議録で「私的録音録画」と著作権法改正が議論された発言を探してください。
```
