...
NDL Search、NDLデジタルコレクション、CiNii Research、J-STAGE を対象にした、日本語文献探索向け MCP サーバーです。`ndl_digital` は独立 API ではなく、NDL Search API に `dpid=ndl-dl` を付けた検索と detail endpoint を利用します。
...
- `source` は `ndl_search`、`ndl_catalog`、`ndl_digital`、`ndl_articles`、`ndl_articles_online`、`cinii_research`、`cinii_articles`、`cinii_books`、`jstage_articles` を取ります。
