...
CiNii Research の `appid` とカーリル図書館MCPは必須ではありません。ただし、CiNii / KAKEN や地域資料・公共図書館調査をよく使うなら、最初に設定しておくと便利です。入れ先は下の [追加で入れると便利な設定](#追加で入れると便利な設定) にまとめています。
...
```text
文献DBで、日本のゲーム研究について、CiNii、J-STAGE、IRDB を中心に論文を探してください。
```
